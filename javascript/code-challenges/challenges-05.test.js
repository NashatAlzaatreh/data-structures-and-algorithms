...
const addPurchases = (arr) => {
  // Solution code here...
  let totalPurchases = arr.reduce((accumulator, value) => {
    accumulator = accumulator + value.purchasePrice;
    return accumulator;
  }, 0);
  return totalPurchases;
};
// console.log(addPurchases(testArr));
/* ------------------------------------------------------------------------------------------------
CHALLENGE 4
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let numElements = arr.reduce((acc, value) => {
    acc += 1;
    return acc;
  }, 0);
  return numElements;
};
// console.log(countNumberOfElements([1, 2, 3, 4, 5, 6, 7, 8, 9, 4, 4, 4]));
...
const returnNames = (arr) => {
  // Solution code here...
  let namesArr = arr.reduce((acc, value) => {
    acc.push(value.name);
    return acc;
  }, []);
  return namesArr;
...
const reversedString = (str) => {
  ...
  let reverseStr = splitStr.reduce((acc, item) => {
    return item + acc;
  }, "");
  return reverseStr;
};
// console.log(reversedString("nashat"));
