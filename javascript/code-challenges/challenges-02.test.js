...
// console.log(raisedToTheThird(testArr));
...
const addOne = (arr) => {
  // Solution code here...
  let addOneArr = arr.map((value) => value + 1);
  return addOneArr;
};
...
const addQuestion = (arr) => {
  // Solution code here...
  let addQuestionArr = arr.map((value) => value + "?");
  return addQuestionArr;
};
// console.log(addQuestion (stringsArr));
